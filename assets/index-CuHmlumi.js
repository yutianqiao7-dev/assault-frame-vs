...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function gu(){return new zt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xl(),fragmentShader:`
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function _u(){return new zt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xl(),fragmentShader:`
...
#define LOW_PRECISION`),e}function qx(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Tl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===yd?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===oi&&(e="SHADOWMAP_TYPE_VSM"),e}function Kx(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case $s:case qs:e="ENVMAP_TYPE_CUBE";break;case da:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yx(s){let e="ENVMAP_MODE_REFLECTION";return s.envMap&&s.envMapMode===qs&&(e="ENVMAP_MODE_REFRACTION"),e}function Zx(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case El:e="ENVMAP_BLENDING_MULTIPLY";break;case Zp:e="ENVMAP_BLENDING_MIX";break;case Jp:e="ENVMAP_BLENDING_ADD";break}return e}function Jx(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Qx(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=qx(t),l=Kx(t),h=Yx(t),u=Zx(t),d=Jx(t),f=zx(t),g=Hx(r),_=i.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
`);s.RTCSessionDescription&&i instanceof s.RTCSessionDescription?arguments[0]=new s.RTCSessionDescription({type:i.type,sdp:r}):i.sdp=r}return t.apply(this,arguments)}}function Zo(s,e){if(!(s.RTCPeerConnection&&s.RTCPeerConnection.prototype))return;const t=s.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(s.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Jo(s,e){if(!(s.RTCPeerConnection&&s.RTCPeerConnection.prototype))return;const t=s.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(s.RTCPeerConnection.prototype.setLocalDescription=function(){let i=arguments[0]||{};if(typeof i!="object"||i.type&&i.sdp)return t.apply(this,arguments);if(i={type:i.type,sdp:i.sdp},!i.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":i.type="offer";break;default:i.type="answer";break}return i.sdp||i.type!=="offer"&&i.type!=="answer"?t.apply(this,[i]):(i.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const yM=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:yl,shimAddIceCandidateNullOrEmpty:Zo,shimConnectionState:xl,shimMaxMessageSize:Ko,shimParameterlessSetLocalDescription:Jo,shimRTCIceCandidate:qo,shimRTCIceCandidateRelayProtocol:vl,shimSendThrowTypeError:Yo},Symbol.toStringTag,{value:"Module"}));function SM({window:s}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=Yl,n=mM(s),i={browserDetails:n,commonShim:yM,extractVersion:Pr,disableLog:fM,disableWarnings:pM,sdp:xM};switch(n.browser){case"chrome":if(!ad||!gl||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),i;if(n.version===null)return t("Chrome shim can not determine version, not shimming."),i;t("adapter.js shimming chrome."),i.browserShim=ad,Zo(s,n),Jo(s),Af(s,n),Cf(s),gl(s,n),Rf(s,n),If(s,n),Pf(s),Df(s,n),Uf(s,n),qo(s),vl(s),xl(s),Ko(s,n),Yo(s,n),yl(s,n);break;case"firefox":if(!cd||!_l||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),i;t("adapter.js shimming firefox."),i.browserShim=cd,Zo(s,n),Jo(s),Nf(s,n),_l(s,n),Of(s,n),kf(s),zf(s),Ff(s),Bf(s),Hf(s),Vf(s,n),Gf(s,n),Wf(s,n),Xf(s,n),qo(s),xl(s),Ko(s,n),Yo(s,n);break;case"safari":if(!ld||!e.shimSafari)return t("Safari shim is not included in this adapter release."),i;t("adapter.js shimming safari."),i.browserShim=ld,Zo(s,n),Jo(s),Zf(s),Qf(s),qf(s),jf(s),$f(s),Jf(s),Kf(s),ep(s),qo(s),vl(s),Ko(s,n),Yo(s,n),yl(s,n);break;default:t("Unsupported browser!");break}return i}const ud=SM({window:typeof window>"u"?void 0:window});function hs(s,e,t,n){Object.defineProperty(s,e,{get:t,set:n,enumerable:!0,configurable:!0})}class np{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],n=e.byteLength,i=Math.ceil(n/this.chunkedMTU);let r=0,o=0;for(;o<n;){const a=Math.min(n,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:r,data:c,total:i};t.push(l),o=a,r++}return this._dataCount++,t}}}function MM(s){let e=0;for(const i of s)e+=i.byteLength;const t=new Uint8Array(e);let n=0;for(const i of s)t.set(i,n),n+=i.byteLength;return t}const gc=ud.default||ud,br=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const s=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(s)?s==="chrome"?e>=this.minChromeVersion:s==="firefox"?e>=this.minFirefoxVersion:s==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return gc.browserDetails.browser}getVersion(){return gc.browserDetails.version||0}isUnifiedPlanSupported(){const s=this.getBrowser(),e=gc.browserDetails.version||0;if(s==="chrome"&&e<this.minChromeVersion)return!1;if(s==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,n=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),n=!0}catch{}finally{t&&t.close()}return n}toString(){return`Supports:
    ...
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<"u"?["iPad","iPhone","iPod"].includes(navigator.platform):!1,this.supportedBrowsers=["firefox","chrome","safari"],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},bM=s=>!s||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(s),ip=()=>Math.random().toString(36).slice(2),dd={iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:["turn:eu-0.turn.peerjs.com:3478","turn:us-0.turn.peerjs.com:3478"],username:"peerjs",credential:"peerjsp"}],sdpSemantics:"unified-plan"};class TM extends np{noop(){}blobToArrayBuffer(e,t){const n=new FileReader;return n.onload=function(i){i.target&&t(i.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){const t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol==="https:"}constructor(...e){super(...e),this.CLOUD_HOST="0.peerjs.com",this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=dd,this.browser=br.getBrowser(),this.browserVersion=br.getVersion(),this.pack=bf,this.unpack=Mf,this.supports=(function(){const t={browser:br.isBrowserSupported(),webRTC:br.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!t.webRTC)return t;let n;try{n=new RTCPeerConnection(dd),t.audioVideo=!0;let i;try{i=n.createDataChannel("_PEERJSTEST",{ordered:!0}),t.data=!0,t.reliable=!!i.ordered;try{i.binaryType="blob",t.binaryBlob=!br.isIOS}catch{}}catch{}finally{i&&i.close()}}catch{}finally{n&&n.close()}return t})(),this.validateId=bM,this.randomToken=ip}}const rn=new TM,EM="PeerJS: ";class wM{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){const n=[EM,...t];for(const i in n)n[i]instanceof Error&&(n[i]="("+n[i].name+") "+n[i].message);e>=3?console.log(...n):e>=2?console.warn("WARNING",...n):e>=1&&console.error("ERROR",...n)}constructor(){this._logLevel=0}}var me=new wM,Jl={},AM=Object.prototype.hasOwnProperty,tn="~";function $r(){}Object.create&&($r.prototype=Object.create(null),new $r().__proto__||(tn=!1));function CM(s,e,t){this.fn=s,this.context=e,this.once=t||!1}function sp(s,e,t,n,i){if(typeof t!="function")throw new TypeError("The listener must be a function");var r=new CM(t,n||s,i),o=tn?tn+e:e;return s._events[o]?s._events[o].fn?s._events[o]=[s._events[o],r]:s._events[o].push(r):(s._events[o]=r,s._eventsCount++),s}function Qo(s,e){--s._eventsCount===0?s._events=new $r:delete s._events[e]}function qt(){this._events=new $r,this._eventsCount=0}qt.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)AM.call(t,n)&&e.push(tn?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e};qt.prototype.listeners=function(e){var t=tn?tn+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var i=0,r=n.length,o=new Array(r);i<r;i++)o[i]=n[i].fn;return o};qt.prototype.listenerCount=function(e){var t=tn?tn+e:e,n=this._events[t];return n?n.fn?1:n.length:0};qt.prototype.emit=function(e,t,n,i,r,o){var a=tn?tn+e:e;if(!this._events[a])return!1;var c=this._events[a],l=arguments.length,h,u;if(c.fn){switch(c.once&&this.removeListener(e,c.fn,void 0,!0),l){case 1:return c.fn.call(c.context),!0;case 2:return c.fn.call(c.context,t),!0;case 3:return c.fn.call(c.context,t,n),!0;case 4:return c.fn.call(c.context,t,n,i),!0;case 5:return c.fn.call(c.context,t,n,i,r),!0;case 6:return c.fn.call(c.context,t,n,i,r,o),!0}for(u=1,h=new Array(l-1);u<l;u++)h[u-1]=arguments[u];c.fn.apply(c.context,h)}else{var d=c.length,f;for(u=0;u<d;u++)switch(c[u].once&&this.removeListener(e,c[u].fn,void 0,!0),l){case 1:c[u].fn.call(c[u].context);break;case 2:c[u].fn.call(c[u].context,t);break;case 3:c[u].fn.call(c[u].context,t,n);break;case 4:c[u].fn.call(c[u].context,t,n,i);break;default:if(!h)for(f=1,h=new Array(l-1);f<l;f++)h[f-1]=arguments[f];c[u].fn.apply(c[u].context,h)}}return!0};qt.prototype.on=function(e,t,n){return sp(this,e,t,n,!1)};qt.prototype.once=function(e,t,n){return sp(this,e,t,n,!0)};qt.prototype.removeListener=function(e,t,n,i){var r=tn?tn+e:e;if(!this._events[r])return this;if(!t)return Qo(this,r),this;var o=this._events[r];if(o.fn)o.fn===t&&(!i||o.once)&&(!n||o.context===n)&&Qo(this,r);else{for(var a=0,c=[],l=o.length;a<l;a++)(o[a].fn!==t||i&&!o[a].once||n&&o[a].context!==n)&&c.push(o[a]);c.length?this._events[r]=c.length===1?c[0]:c:Qo(this,r)}return this};qt.prototype.removeAllListeners=function(e){var t;return e?(t=tn?tn+e:e,this._events[t]&&Qo(this,t)):(this._events=new $r,this._eventsCount=0),this};qt.prototype.off=qt.prototype.removeListener;qt.prototype.addListener=qt.prototype.on;qt.prefixed=tn;qt.EventEmitter=qt;Jl=qt;var us={};hs(us,"ConnectionType",()=>ki);hs(us,"PeerErrorType",()=>Ct);hs(us,"BaseConnectionErrorType",()=>Sl);hs(us,"DataConnectionErrorType",()=>Ql);hs(us,"SerializationType",()=>va);hs(us,"SocketEventType",()=>Ii);hs(us,"ServerMessageType",()=>Xt);var ki=(function(s){return s.Data="data",s.Media="media",s})({}),Ct=(function(s){return s.BrowserIncompatible="browser-incompatible",s.Disconnected="disconnected",s.InvalidID="invalid-id",s.InvalidKey="invalid-key",s.Network="network",s.PeerUnavailable="peer-unavailable",s.SslUnavailable="ssl-unavailable",s.ServerError="server-error",s.SocketError="socket-error",s.SocketClosed="socket-closed",s.UnavailableID="unavailable-id",s.WebRTC="webrtc",s})({}),Sl=(function(s){return s.NegotiationFailed="negotiation-failed",s.ConnectionClosed="connection-closed",s})({}),Ql=(function(s){return s.NotOpenYet="not-open-yet",s.MessageToBig="message-too-big",s})({}),va=(function(s){return s.Binary="binary",s.BinaryUTF8="binary-utf8",s.JSON="json",s.None="raw",s})({}),Ii=(function(s){return s.Message="message",s.Disconnected="disconnected",s.Error="error",s.Close="close",s})({}),Xt=(function(s){return s.Heartbeat="HEARTBEAT",s.Candidate="CANDIDATE",s.Offer="OFFER",s.Answer="ANSWER",s.Open="OPEN",s.Error="ERROR",s.IdTaken="ID-TAKEN",s.InvalidKey="INVALID-KEY",s.Leave="LEAVE",s.Expire="EXPIRE",s})({});const rp="1.5.5";class RM extends Jl.EventEmitter{constructor(e,t,n,i,r,o=5e3){super(),this.pingInterval=o,this._disconnected=!0,this._messagesQueue=[];const a=e?"wss://":"ws://";this._baseUrl=a+t+":"+n+i+"peerjs?key="+r}start(e,t){this._id=e;const n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+"&version="+rp),this._disconnected=!1,this._socket.onmessage=i=>{let r;try{r=JSON.parse(i.data),me.log("Server message received:",r)}catch{me.log("Invalid server message",i.data);return}this.emit(Ii.Message,r)},this._socket.onclose=i=>{this._disconnected||(me.log("Socket closed.",i),this._cleanup(),this._disconnected=!0,this.emit(Ii.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),me.log("Socket open"),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){me.log("Cannot send heartbeat, because socket closed");return}const e=JSON.stringify({type:Xt.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){const e=[...this._messagesQueue];this._messagesQueue=[];for(const t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(Ii.Error,"Invalid message");return}if(!this._wsOpen())return;const t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||(this._cleanup(),this._disconnected=!0)}_cleanup(){this._socket&&(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),this._socket=void 0),clearTimeout(this._wsPingTimer)}}class op{constructor(e){this.connection=e}startConnection(e){const t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===ki.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){const n=this.connection,i={ordered:!!e.reliable},r=t.createDataChannel(n.label,i);n._initializeDataChannel(r),this._makeOffer()}else this.handleSDP("OFFER",e.sdp)}_startPeerConnection(){me.log("Creating RTCPeerConnection.");const e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){const t=this.connection.peer,n=this.connection.connectionId,i=this.connection.type,r=this.connection.provider;me.log("Listening for ICE candidates."),e.onicecandidate=o=>{!o.candidate||!o.candidate.candidate||(me.log(`Received ICE candidates for ${t}:`,o.candidate),r.socket.send({type:Xt.Candidate,payload:{candidate:o.candidate,type:i,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case"failed":me.log("iceConnectionState is failed, closing connections to "+t),this.connection.emitError(Sl.NegotiationFailed,"Negotiation of connection to "+t+" failed."),this.connection.close();break;case"closed":me.log("iceConnectionState is closed, closing connections to "+t),this.connection.emitError(Sl.ConnectionClosed,"Connection to "+t+" closed."),this.connection.close();break;case"disconnected":me.log("iceConnectionState changed to disconnected on the connection with "+t);break;case"completed":e.onicecandidate=()=>{};break}this.connection.emit("iceStateChanged",e.iceConnectionState)},me.log("Listening for data channel"),e.ondatachannel=o=>{me.log("Received data channel");const a=o.channel;r.getConnection(t,n)._initializeDataChannel(a)},me.log("Listening for remote stream"),e.ontrack=o=>{me.log("Received remote stream");const a=o.streams[0],c=r.getConnection(t,n);if(c.type===ki.Media){const l=c;this._addStreamToMediaConnection(a,l)}}}cleanup(){me.log("Cleaning up PeerConnection to "+this.connection.peer);const e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};const t=e.signalingState!=="closed";let n=!1;const i=this.connection.dataChannel;i&&(n=!!i.readyState&&i.readyState!=="closed"),(t||n)&&e.close()}async _makeOffer(){const e=this.connection.peerConnection,t=this.connection.provider;try{const n=await e.createOffer(this.connection.options.constraints);me.log("Created offer."),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform=="function"&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),me.log("Set localDescription:",n,`for:${this.connection.peer}`);let i={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===ki.Data){const r=this.connection;i={...i,label:r.label,reliable:r.reliable,serialization:r.serialization}}t.socket.send({type:Xt.Offer,payload:i,dst:this.connection.peer})}catch(i){i!="OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer"&&(t.emitError(Ct.WebRTC,i),me.log("Failed to setLocalDescription, ",i))}}catch(n){t.emitError(Ct.WebRTC,n),me.log("Failed to createOffer, ",n)}}async _makeAnswer(){const e=this.connection.peerConnection,t=this.connection.provider;try{const n=await e.createAnswer();me.log("Created answer."),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform=="function"&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),me.log("Set localDescription:",n,`for:${this.connection.peer}`),t.socket.send({type:Xt.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(i){t.emitError(Ct.WebRTC,i),me.log("Failed to setLocalDescription, ",i)}}catch(n){t.emitError(Ct.WebRTC,n),me.log("Failed to create answer, ",n)}}async handleSDP(e,t){t=new RTCSessionDescription(t);const n=this.connection.peerConnection,i=this.connection.provider;me.log("Setting remote description",t);const r=this;try{await n.setRemoteDescription(t),me.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e==="OFFER"&&await r._makeAnswer()}catch(o){i.emitError(Ct.WebRTC,o),me.log("Failed to setRemoteDescription, ",o)}}async handleCandidate(e){me.log("handleCandidate:",e);try{await this.connection.peerConnection.addIceCandidate(e),me.log(`Added ICE candidate for:${this.connection.peer}`)}catch(t){this.connection.provider.emitError(Ct.WebRTC,t),me.log("Failed to handleCandidate, ",t)}}_addTracksToConnection(e,t){if(me.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return me.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){me.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}}class ap extends Jl.EventEmitter{emitError(e,t){me.error("Error:",t),this.emit("error",new PM(`${e}`,t))}}class PM extends Error{constructor(e,t){typeof t=="string"?super(t):(super(),Object.assign(this,t)),this.type=e}}class cp extends ap{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}}class aa extends cp{static#e=this.ID_PREFIX="mc_";get type(){return ki.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(e,t,n){super(e,t,n),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||aa.ID_PREFIX+rn.randomToken(),this._negotiator=new op(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{me.log(`DC#${this.connectionId} dc connection success`),this.emit("willCloseOnRemote")},this.dataChannel.onclose=()=>{me.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){me.log("Receiving stream",e),this._remoteStream=e,super.emit("stream",e)}handleMessage(e){const t=e.type,n=e.payload;switch(e.type){case Xt.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case Xt.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:me.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){me.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});const n=this.provider._getMessages(this.connectionId);for(const i of n)this.handleMessage(i);this._open=!0}close(){this._negotiator&&(this._negotiator.cleanup(),this._negotiator=null),this._localStream=null,this._remoteStream=null,this.provider&&(this.provider._removeConnection(this),this.provider=null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit("close"))}}class DM{constructor(e){this._options=e}_buildRequest(e){const t=this._options.secure?"https":"http",{host:n,port:i,path:r,key:o}=this._options,a=new URL(`${t}://${n}:${i}${r}${o}/${e}`);return a.searchParams.set("ts",`${Date.now()}${Math.random()}`),a.searchParams.set("version",rp),fetch(a.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{const e=await this._buildRequest("id");if(e.status!==200)throw new Error(`Error. Status:${e.status}`);return e.text()}catch(e){me.error("Error retrieving ID",e);let t="";throw this._options.path==="/"&&this._options.host!==rn.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),new Error("Could not get an ID from the server."+t)}}async listAllPeers(){try{const e=await this._buildRequest("peers");if(e.status!==200){if(e.status===401){let t="";throw this._options.host===rn.CLOUD_HOST?t="It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.":t="You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",new Error("It doesn't look like you have permission to list peers IDs. "+t)}throw new Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw me.error("Error retrieving list peers",e),new Error("Could not get list peers from the server."+e)}}}class ca extends cp{static#e=this.ID_PREFIX="dc_";static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return ki.Data}constructor(e,t,n){super(e,t,n),this.connectionId=this.options.connectionId||ca.ID_PREFIX+ip(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new op(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{me.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit("open")},this.dataChannel.onmessage=t=>{me.log(`DC#${this.connectionId} dc onmessage:`,t.data)},this.dataChannel.onclose=()=>{me.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:"close"}});return}this._negotiator&&(this._negotiator.cleanup(),this._negotiator=null),this.provider&&(this.provider._removeConnection(this),this.provider=null),this.dataChannel&&(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,this.dataChannel=null),this.open&&(this._open=!1,super.emit("close"))}send(e,t=!1){if(!this.open){this.emitError(Ql.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){const t=e.payload;switch(e.type){case Xt.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case Xt.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:me.warn("Unrecognized message type:",e.type,"from peer:",this.peer);break}}}class eh extends ca{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType="arraybuffer",this.dataChannel.addEventListener("message",t=>this._handleDataMessage(t))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>ca.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(t){return me.error(`DC#:${this.connectionId} Error when sending:`,t),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;const e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:"close"}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}}class _c extends eh{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new np,this.serialization=va.Binary,this._chunkedData={}}_handleDataMessage({data:e}){const t=Mf(e),n=t.__peerData;if(n){if(n.type==="close"){this.close();return}this._handleChunk(t);return}this.emit("data",t)}_handleChunk(e){const t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];const i=MM(n.data);this._handleDataMessage({data:i})}}_send(e,t){const n=bf(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){const t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){const t=this.chunker.chunk(e);me.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(const n of t)this.send(n,!0)}}class LM extends eh{_handleDataMessage({data:e}){super.emit("data",e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=va.None}}class IM extends eh{_handleDataMessage({data:e}){const t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type==="close"){this.close();return}this.emit("data",t)}_send(e,t){const n=this.encoder.encode(this.stringify(e));if(n.byteLength>=rn.chunkedMTU){this.emitError(Ql.MessageToBig,"Message too big for JSON channel");return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=va.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}}class th extends ap{static#e=this.DEFAULT_KEY="peerjs";get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){const e=Object.create(null);for(const[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(e,t){super(),this._serializers={raw:LM,json:IM,binary:_c,"binary-utf8":_c,default:_c},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let n;if(e&&e.constructor==Object?t=e:e&&(n=e.toString()),t={debug:0,host:rn.CLOUD_HOST,port:rn.CLOUD_PORT,path:"/",key:th.DEFAULT_KEY,token:rn.randomToken(),config:rn.defaultConfig,referrerPolicy:"strict-origin-when-cross-origin",serializers:{},...t},this._options=t,this._serializers={...this._serializers,...this.options.serializers},this._options.host==="/"&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!=="/"&&(this._options.path="/"+this._options.path),this._options.path[this._options.path.length-1]!=="/"&&(this._options.path+="/")),this._options.secure===void 0&&this._options.host!==rn.CLOUD_HOST?this._options.secure=rn.isSecure():this._options.host==rn.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&me.setLogFunction(this._options.logFunction),me.logLevel=this._options.debug||0,this._api=new DM(t),this._socket=this._createServerConnection(),!rn.supports.audioVideo&&!rn.supports.data){this._delayedAbort(Ct.BrowserIncompatible,"The current browser does not support WebRTC");return}if(n&&!rn.validateId(n)){this._delayedAbort(Ct.InvalidID,`ID "${n}" is invalid`);return}n?this._initialize(n):this._api.retrieveId().then(i=>this._initialize(i)).catch(i=>this._abort(Ct.ServerError,i))}_createServerConnection(){const e=new RM(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(Ii.Message,t=>{this._handleMessage(t)}),e.on(Ii.Error,t=>{this._abort(Ct.SocketError,t)}),e.on(Ii.Disconnected,()=>{this.disconnected||(this.emitError(Ct.Network,"Lost connection to server."),this.disconnect())}),e.on(Ii.Close,()=>{this.disconnected||this._abort(Ct.SocketClosed,"Underlying socket is already closed.")}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){const t=e.type,n=e.payload,i=e.src;switch(t){case Xt.Open:this._lastServerId=this.id,this._open=!0,this.emit("open",this.id);break;case Xt.Error:this._abort(Ct.ServerError,n.msg);break;case Xt.IdTaken:this._abort(Ct.UnavailableID,`ID "${this.id}" is taken`);break;case Xt.InvalidKey:this._abort(Ct.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case Xt.Leave:me.log(`Received leave message from ${i}`),this._cleanupPeer(i),this._connections.delete(i);break;case Xt.Expire:this.emitError(Ct.PeerUnavailable,`Could not connect to peer ${i}`);break;case Xt.Offer:{const r=n.connectionId;let o=this.getConnection(i,r);if(o&&(o.close(),me.warn(`Offer received for existing Connection ID:${r}`)),n.type===ki.Media){const c=new aa(i,this,{connectionId:r,_payload:n,metadata:n.metadata});o=c,this._addConnection(i,o),this.emit("call",c)}else if(n.type===ki.Data){const c=new this._serializers[n.serialization](i,this,{connectionId:r,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});o=c,this._addConnection(i,o),this.emit("connection",c)}else{me.warn(`Received malformed connection type:${n.type}`);return}const a=this._getMessages(r);for(const c of a)o.handleMessage(c);break}default:{if(!n){me.warn(`You received a malformed message from ${i} of type ${t}`);return}const r=n.connectionId,o=this.getConnection(i,r);o&&o.peerConnection?o.handleMessage(e):r?this._storeMessage(r,e):me.warn("You received an unrecognized message:",e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){const t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:"default",...t},this.disconnected){me.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."),this.emitError(Ct.Disconnected,"Cannot connect to new Peer after disconnecting from server.");return}const n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){me.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),this.emitError(Ct.Disconnected,"Cannot connect to new Peer after disconnecting from server.");return}if(!t){me.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}const i=new aa(e,this,{...n,_stream:t});return this._addConnection(e,i),i}_addConnection(e,t){me.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){const t=this._connections.get(e.peer);if(t){const n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){const n=this._connections.get(e);if(!n)return null;for(const i of n)if(i.connectionId===t)return i;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){me.error("Aborting!"),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(me.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit("close"))}_cleanup(){for(const e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){const t=this._connections.get(e);if(t)for(const n of t)n.close()}disconnect(){if(this.disconnected)return;const e=this.id;me.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit("disconnected",e)}reconnect(){if(this.disconnected&&!this.destroyed)me.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else{if(this.destroyed)throw new Error("This peer cannot reconnect to the server. It has already been destroyed.");if(!this.disconnected&&!this.open)me.error("In a hurry? We're still trying to make the initial connection!");else throw new Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}}listAllPeers(e=t=>{}){this._api.listAllPeers().then(t=>e(t)).catch(t=>this._abort(Ct.ServerError,t))}}var UM=th;const fd="ABCDEFGHJKMNPQRSTUVWXYZ23456789",pd="afvs-";function NM(s=4){let e="";for(let t=0;t<s;t++)e+=fd[Math.random()*fd.length|0];return e}function nh(s){return(s||"").toUpperCase().replace(/[^A-Z0-9]/g,"").slice(0,4)}class kM{constructor(){this.peer=null,this.conn=null,this.role=null,this.code="",this.state="idle",this.error="",this.onState=()=>{},this.onMessage=()=>{},this.pingMs=0,this._pingSent=0,this._pingTimer=null}setState(e,t=""){this.state=e,this.error=t,this.onState(e,t)}get connected(){return this.state==="connected"&&this.conn&&this.conn.open}_newPeer(e){return new UM(e,{debug:0})}async host(e=0){this.close(),this.role="host",this.setState("opening");const t=NM();return new Promise((n,i)=>{const r=this._newPeer(pd+t);this.peer=r;let o=!1;r.on("open",()=>{this.code=t,o=!0,this.setState("waiting"),n(t)}),r.on("connection",a=>{if(this.conn){a.close();return}this._bind(a)}),r.on("error",a=>{if(!o&&a.type==="unavailable-id"&&e<5){r.destroy(),this.host(e+1).then(n,i);return}o?this.setState("error",Tr(a)):(this.setState("error",Tr(a)),i(a))})})}async join(e){return this.close(),this.role="guest",this.code=nh(e),this.setState("connecting"),new Promise((t,n)=>{const i=this._newPeer(null);this.peer=i;let r=!1;i.on("open",()=>{const o=i.connect(pd+this.code,{reliable:!0}),a=setTimeout(()=>{r||(r=!0,this.setState("error","その部屋コードの相手が見つかりません"),n(new Error("timeout")))},12e3);o.on("open",()=>{clearTimeout(a),r=!0,this._bind(o),t()})}),i.on("error",o=>{r?this.setState("error",Tr(o)):(r=!0,this.setState("error",Tr(o)),n(o))})})}_bind(e){this.conn=e,e.on("data",t=>{if(t&&t.t==="ping"){this.send({t:"pong",a:t.a});return}if(t&&t.t==="pong"){this.pingMs=Math.round(performance.now()-t.a);return}this.onMessage(t)}),e.on("close",()=>{this.setState("closed"),this.conn=null}),e.on("error",t=>this.setState("error",Tr(t))),this.setState("connected"),clearInterval(this._pingTimer),this._pingTimer=setInterval(()=>{this.connected&&this.send({t:"ping",a:performance.now()})},1e3)}send(e){if(this.conn&&this.conn.open)try{this.conn.send(e)}catch{}}close(){if(clearInterval(this._pingTimer),this._pingTimer=null,this.conn){try{this.conn.close()}catch{}this.conn=null}if(this.peer){try{this.peer.destroy()}catch{}this.peer=null}this.role=null,this.code="",this.pingMs=0,this.state!=="idle"&&this.setState("idle")}}function Tr(s){const e=s&&s.type;return e==="peer-unavailable"?"その部屋コードの相手が見つかりません":e==="unavailable-id"?"部屋コードが使用中です":e==="network"||e==="server-error"?"接続サーバーに繋がりません":e==="browser-incompatible"?"このブラウザは通信対戦に対応していません":s&&(s.message||s.type)||"接続エラー"}const lp=["free","step","land","fire","rush","swing","stagger","down","wake","dead"],Xn=s=>Math.round(s*100)/100,En=s=>Math.round(s*10)/10;function md(s){const e=s.root.userData;return[Xn(s.pos.x),Xn(s.pos.y),Xn(s.pos.z),En(s.vel.x),En(s.vel.y),En(s.vel.z),Xn(s.yaw),lp.indexOf(s.st),Xn(s.stT),Xn(s.stDur),s.hp,Math.round(s.boost),(s.overheat?1:0)|(s.grounded?2:0)|(s.boosting?4:0)|(e.saber.visible?8:0),En(s.invuln),Math.round(s.awake),En(s.awakeT),s.ammo.shot??0,s.ammo.sub??0,s.ammo.sp_shot??0,s.ammo.sp_melee??0,s.meleeStage,jl.indexOf(s.meleeDir),mi.indexOf(s.fireKey)]}function gd(s,e,t=1){const n=s.root.userData;s.pos.x+=(e[0]-s.pos.x)*t,s.pos.y+=(e[1]-s.pos.y)*t,s.pos.z+=(e[2]-s.pos.z)*t,s.vel.set(e[3],e[4],e[5]),s.yaw=e[6],s.st=lp[e[7]]||"free",s.stT=e[8],s.stDur=e[9],s.hp=e[10],s.boost=e[11];const i=e[12];s.overheat=!!(i&1),s.grounded=!!(i&2),s.boosting=!!(i&4),n.saber.visible=!!(i&8),s.invuln=e[13],s.awake=e[14],s.awakeT=e[15],s.awakeReady=s.awake>=100&&s.awakeT<=0,s.ammo.shot=e[16],s.ammo.sub=e[17],s.ammo.sp_shot=e[18],s.ammo.sp_melee=e[19],s.meleeStage=e[20],s.meleeDir=jl[e[21]]||"n",s.meleeVar=s.d.melee[s.meleeDir]||s.d.melee.n,s.fireKey=mi[e[22]]||null}function OM(s,e){const t=[];for(const n of s)n.netId!=null&&t.push(n.netId,e.indexOf(n.owner),mi.indexOf(n.key),En(n.pos.x),En(n.pos.y),En(n.pos.z),Math.round(n.vel.x),Math.round(n.vel.y),Math.round(n.vel.z));return t}function FM(s,e){const t=[];for(const n of s)n.netId!=null&&t.push(n.netId,e.indexOf(n.owner),En(n.pos.x),En(n.pos.y),En(n.pos.z));return t}function BM(s,e){const t=[];for(const n of s)t.push(e.indexOf(n.owner),Xn(n.dir.x),Xn(n.dir.y),Xn(n.dir.z),Xn(n.life));return t}function zM(s,e,t){const n=e.mechs;return{t:"s",n:t,m:[md(n[0]),md(n[1])],p:OM(e.projectiles.list,n),b:FM(e.projectiles.bits,n),l:BM(e.projectiles.beams,n),tm:En(s.time),c:[s.cost.ally,s.cost.foe],o:s.over?1:0}}const ea={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class ar{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const HM=new ga(-1,1,1,-1,0,1);class VM extends Pt{constructor(){super(),this.setAttribute("position",new ht([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ht([0,2,0,0,2,0],2))}}const GM=new VM;class ih{constructor(e){this._mesh=new be(GM,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,HM)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class WM extends ar{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof zt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Gr.clone(e.uniforms),this.material=new zt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ih(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class _d extends ar{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const i=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),r.buffers.stencil.setFunc(i.ALWAYS,o,4294967295),r.buffers.stencil.setClear(a),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(i.EQUAL,1,4294967295),r.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),r.buffers.stencil.setLocked(!0)}}class XM extends ar{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class jM{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new we);this._width=n.width,this._height=n.height,t=new Un(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:fi}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new WM(ea),this.copyPass.material.blending=di,this.clock=new U0}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let i=0,r=this.passes.length;i<r;i++){const o=this.passes[i];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),o.needsSwap){if(n){const a=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}_d!==void 0&&(o instanceof _d?n=!0:o instanceof XM&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new we);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,i)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class $M extends ar{constructor(e,t,n=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ue}render(e,t,n){const i=e.autoClear;e.autoClear=!1;let r,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=i}}const qM={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new ue(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		}`};class KM extends ar{constructor(){super(),this.uniforms=Gr.clone(zo.uniforms),this.material=new l0({name:zo.name,uniforms:this.uniforms,vertexShader:zo.vertexShader,fragmentShader:zo.fragmentShader}),this._fsQuad=new ih(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Ke.getTransfer(this._outputColorSpace)===st&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===Sd?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===Md?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===bd?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===wl?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===Ed?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===wd?this.material.defines.NEUTRAL_TONE_MAPPING="":this._toneMapping===Td&&(this.material.defines.CUSTOM_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}const YM=document.getElementById("app"),tr=matchMedia("(pointer: coarse)").matches||innerWidth<760,yi=new Ay({antialias:!tr,powerPreference:"high-performance",preserveDrawingBuffer:!1});yi.setPixelRatio(Math.min(devicePixelRatio,tr?1.5:2));yi.shadowMap.enabled=!0;yi.shadowMap.type=tr?Tl:yd;yi.toneMapping=wl;yi.toneMappingExposure=1.12;YM.appendChild(yi.domElement);const nr=new jd,hi=new Qt(52,1,.5,1200),gn=new iM(hi),sh=new cM([]);let Gn=null,Nn=localStorage.getItem("gvs.stage")||ss;$l[Nn]||(Nn=ss);async function qr(s){if(Gn&&Gn.id===s)return;await(async()=>{const t=await IS(nr,yi,s);Gn&&Gn.dispose(),t.id=s,Gn=t,gn.colliders=Gn.buildings,sh.boxes=Gn.boxes,hi.far=Gn.far,hi.updateProjectionMatrix()})()}const eo=new jM(yi);eo.addPass(new $M(nr,hi));const hp=new er(new we(1,1),tr?.42:.55,tr?.45:.55,.86);eo.addPass(hp);eo.addPass(new KM);function ZM(){eo.render()}const Fi=new nM(nr),Je={scene:nr,fx:Fi,collision:sh,projectiles:null,mechs:[],spawnShot(s,e){Je.projectiles.spawn(s,e)},hit(s,e,t,n,i,r,o){e.takeHit(s,t,n,i,r,o)>0&&(e===re.self||s===re.self)&&gn.bump(o==="melee"?.55:.3)},onDeath(s,e){const t=s.team==="ally"?"ally":"foe";re.cost[t]=Math.max(0,re.cost[t]-s.d.cost),gn.bump(1.2),re.cost[t]<=0?gp(t==="ally"?"lose":"win",s):(mn.message(s===re.self?"DOWN...":"DESTROYED",s===re.self?"#ff6b74":"#ffcf4d"),ib(.09,.12))},breakHoming(s){let e=0;for(const t of Je.projectiles.list)t.owner.team!==s.team&&t.homing>0&&(t.homing=0,e++);return e},msg(s){mn.message(s,"#ffcf4d")}};Je.projectiles=new tM(Je);const mn=new oM,Er=new sM,re={self:null,foe:null,ai:null,camera:hi,cost:{ally:Bs,foe:Bs},time:ku,running:!1,paused:!1,over:!1,mode:"cpu",init(s="brave",e="garm",t="normal"){for(const r of Je.mechs)nr.remove(r.root),r.trail&&nr.remove(r.trail.mesh);Je.mechs.length=0,Je.projectiles.clear(),Fi.clear();const n=new Zu(Oi[s],"ally",Je),i=new Zu(Oi[e],"foe",Je);n.isPlayer=!0,n.target=i,i.target=n,n.pos.set(0,0,-42),n.yaw=0,i.pos.set(0,0,42),i.yaw=Math.PI,Je.mechs.push(n,i),this.self=n,this.foe=i,this.ai=this.mode==="cpu"?new rM(i,Je,t):null,this.cost.ally=Bs,this.cost.foe=Bs,this.time=ku,this.over=!1,mn.setup(n,i),gn.snap(n,i)},finish(s){if(this.over)return;this.over=!0,this.running=!1,this.paused=!1,document.getElementById("pauseBtn").classList.add("hidden"),document.getElementById("pauseMenu").classList.add("hidden"),document.getElementById("touch").classList.add("hidden");const e=document.getElementById("result"),t=document.getElementById("resTitle");t.textContent=s==="win"?"MISSION COMPLETE":s==="lose"?"MISSION FAILED":"DRAW",t.className=s==="win"?"win":"lose",e.classList.remove("hidden"),this.mode==="host"&&mt.connected&&!jt.active&&mt.send({t:"end",r:s}),ve("againBtn").classList.toggle("hidden",this.mode!=="cpu")}};let vd=0,xd=0;function rh(){const s=Math.max(1,Math.floor(visualViewport?visualViewport.width:innerWidth)),e=Math.max(1,Math.floor(visualViewport?visualViewport.height:innerHeight));if(s===vd&&e===xd)return;vd=s,xd=e,yi.setSize(s,e,!1),eo.setSize(s,e);const t=tr?.5:1;hp.setSize(Math.max(1,Math.floor(s*t)),Math.max(1,Math.floor(e*t))),hi.aspect=s/e;const n=e>s;gn.portrait=n,hi.fov=n?62:hi.aspect<1.7?54:48,hi.updateProjectionMatrix()}addEventListener("resize",rh);rh();function JM(s){if(re.paused){Er.read(),Er.endFrame();return}const e=re.running?Er.read():es;if(re.mode==="guest"){fb(s,e),Er.endFrame();return}if(re.running&&!re.over&&(re.time-=s,re.time<=0)){re.time=0;const n=re.cost.ally===re.cost.foe?"draw":re.cost.ally>re.cost.foe?"win":"lose";re.finish(n)}const t=re.mode==="host"?hb():re.ai?re.ai.update(s):es;re.self&&re.self.update(s,re.running?e:es),re.foe&&re.foe.update(s,re.running?t:es),Je.projectiles.update(s,Je.mechs),Fi.update(s),jt.active||gn.update(s,re.self,re.foe),re.self&&mn.update(s,re),re.mode==="host"&&db(s),up(),Er.endFrame()}let QM=0;function up(){const s=ve("netPing");if(re.mode==="cpu"||!mt.connected){s.classList.add("hidden");return}s.classList.remove("hidden"),++QM%30===0&&(s.textContent=`PING ${mt.pingMs}ms`)}let os=performance.now();function dp(s){requestAnimationFrame(dp),rh();let e=(s-os)/1e3;os=s,e>.1&&(e=.1),sb(e),ob(e),JM(e*ai),ZM()}let gi=localStorage.getItem("gvs.level")||"easy";for(const s of document.querySelectorAll("#lvPick .lv"))s.classList.toggle("on",s.dataset.lv===gi),s.addEventListener("click",()=>{gi=s.dataset.lv,localStorage.setItem("gvs.level",gi);for(const e of document.querySelectorAll("#lvPick .lv"))e.classList.toggle("on",e===s)});const eb=[["射撃",s=>s.weapons.shot],["サブ",s=>s.weapons.sub],["特射",s=>s.weapons.sp_shot],["特格",s=>s.weapons.sp_melee]];let cn=localStorage.getItem("gvs.self")||"brave",_i=localStorage.getItem("gvs.foe")||"garm";Oi[cn]||(cn="brave");Oi[_i]||(_i="garm");function fp(s){const e=Oi[s],t=document.getElementById("mechInfo"),n=eb.map(([r,o])=>{const a=o(e);return a?`<div><i>${r}</i><span>${a.name}</span></div>`:""}).join(""),i=jl.map(r=>{const o=e.melee[r];return o?`<div><i>${o.label}</i><span>${o.stages.length}段 / 総${o.stages.reduce((a,c)=>a+c.dmg,0)}</span></div>`:""}).join("");t.innerHTML=`
    ...
    <div class="miMoves">${n}${i}</div>`}function pp(s,e){const t=document.getElementById(s);t.innerHTML="";for(const i of Gy){const r=Oi[i],o=document.createElement("button");o.className="mp"+(e?" foeSel":""),o.dataset.id=i,o.innerHTML=`<span class="mpChip">${r.cost}</span>
                   ...
                   <span class="mpCost">${r.role}</span>`,o.addEventListener("click",()=>{e?(_i=i,localStorage.setItem("gvs.foe",i)):(cn=i,localStorage.setItem("gvs.self",i),fp(i));for(const a of t.children)a.classList.toggle("on",a===o);re.running||re.init(cn,_i,gi)}),t.appendChild(o)}const n=e?_i:cn;for(const i of t.children)i.classList.toggle("on",i.dataset.id===n)}pp("selfPick",!1);pp("foePick",!0);fp(cn);function tb(){const s=document.getElementById("stagePick");s.innerHTML="";for(const e of wS){const t=$l[e],n=document.createElement("button");n.className="sp",n.dataset.id=e,n.innerHTML=`<span class="spName">${t.name}</span><span class="spDesc">${t.desc}</span>`,n.addEventListener("click",()=>nb(e)),n.addEventListener("pointerenter",()=>US(e),{once:!0}),s.appendChild(n)}Kr()}function Kr(){for(const s of document.getElementById("stagePick").children)s.classList.toggle("on",s.dataset.id===Nn)}async function nb(s){if(s===Nn&&Gn)return;Nn=s,localStorage.setItem("gvs.stage",s),Kr();const e=document.getElementById("stagePick");e.classList.add("loading");try{await qr(s),re.running||re.init(cn,_i,gi)}catch(t){console.error(t),mn.message("ステージを読み込めませんでした","#ff6b74"),Nn=ss,Kr(),await qr(ss)}finally{e.classList.remove("loading")}}tb();(async()=>{const s=e=>`/assault-frame-vs/${e}`;try{await BS(s("models/mechparts.glb"),s("draco/"))}catch(e){console.warn("機体パーツを読み込めませんでした。簡易モデルで続行します",e)}try{await qr(Nn)}catch(e){console.error(e),Nn=ss,Kr(),await qr(ss)}re.init(cn,_i,gi),os=performance.now(),requestAnimationFrame(dp)})();const ve=s=>document.getElementById(s);let ai=1,Xs=0,mp=1;function ib(s,e){Xs=Math.max(Xs,s),mp=e}const Pi={stop:.14,slow:1.45,ramp:2.35,result:2.75},jt={active:!1,t:0,result:null,victim:null,nextBoom:0,shown:!1};function gp(s,e){jt.active||re.over||(jt.active=!0,jt.t=0,jt.result=s,jt.victim=e,jt.nextBoom=.35,jt.shown=!1,re.running=!1,gn.endFocus(),gn.bump(1.4),Fi.finishBlast(e.pos),rb(.85,.5),ab(s==="win"?"DESTROYED":"SHOT DOWN"),ve("touch").classList.add("hidden"),ve("pauseBtn").classList.add("hidden"),re.mode==="host"&&mt.connected&&mt.send({t:"fin",r:s,v:Je.mechs.indexOf(e)}))}function sb(s){if(Xs>0?(Xs-=s,ai=mp,Xs<=0&&(ai=1)):jt.active||(ai=1),!jt.active)return;const e=jt;e.t+=s,e.t<Pi.stop?ai=.06:e.t<Pi.slow?ai=.24:e.t<Pi.ramp?ai=.24+(e.t-Pi.slow)/(Pi.ramp-Pi.slow)*.76:ai=1,e.t<Pi.ramp&&e.t>=e.nextBoom&&(e.nextBoom=e.t+.22+Math.random()*.2,Fi.secondary(e.victim.pos,4.5),gn.bump(.35)),gn.focusOn(e.victim,e.t,s),!e.shown&&e.t>=Pi.result&&(e.shown=!0,re.finish(e.result))}function oh(){jt.active=!1,jt.victim=null,ai=1,Xs=0,gn.endFocus(),ve("finishBanner").classList.remove("on"),ve("flash").style.opacity="0"}let zs=0,_p=1;function rb(s,e){zs=Math.max(zs,s),_p=e}function ob(s){zs<=0||(zs=Math.max(0,zs-s/_p),ve("flash").style.opacity=String(zs))}function ab(s){const e=ve("finishBanner");ve("finishText").textContent=s,e.classList.remove("on"),e.offsetWidth,e.classList.add("on")}const mt=new kM,cb=30,as=["stepPressed","melee","sub","sp_shot","sp_melee","awake"],la={},xa={},ha={};for(const s of as)la[s]=0,xa[s]=0,ha[s]=0;const Dr={...es};let vc=0,vp=0,ua=null;function lb(s){for(const e of as)s[e]&&la[e]++;mt.send({t:"in",x:Math.round(s.mx*100)/100,y:Math.round(s.my*100)/100,j:s.jump?1:0,s:s.shot?1:0,e:as.map(e=>la[e])})}function hb(){const s=Dr;for(const e of as)s[e]=xa[e]>ha[e],s[e]&&ha[e]++;return s}function ub(s){if(s){if(s.t==="in"){Dr.mx=s.x,Dr.my=s.y,Dr.jump=!!s.j,Dr.shot=!!s.s;for(let e=0;e<as.length;e++)xa[as[e]]=s.e[e];return}if(s.t==="hello"){Ml=Oi[s.mech]?s.mech:"garm",mt.send({t:"start",h:cn,g:Ml,st:Nn}),xc("host");return}if(s.t==="start"){xp=Oi[s.h]?s.h:"brave";const e=$l[s.st]?s.st:ss;e!==Nn||!Gn?(ui("netJoinStatus","ステージを読み込んでいます…"),qr(e).then(()=>{Nn=e,Kr(),xc("guest")}).catch(()=>{ui("netJoinStatus","ステージを読み込めませんでした",!0),mt.close()})):xc("guest");return}if(s.t==="s"){ua=s;return}if(s.t==="fin"){const e=Je.mechs[s.v],t=s.r==="win"?"lose":s.r==="lose"?"win":"draw";e?gp(t,e):re.finish(t);return}if(s.t==="end"){if(jt.active)return;re.finish(s.r==="win"?"lose":s.r==="lose"?"win":"draw");return}if(s.t==="menu"){yp();return}}}let Ml="garm",xp="brave";function db(s){vc+=s,!(vc<1/cb)&&(vc=0,mt.connected&&mt.send(zM(re,Je,++vp)))}function fb(s,e){mt.connected&&lb(e);const t=ua;if(t){ua=null,gd(Je.mechs[0],t.m[0],.4),gd(Je.mechs[1],t.m[1],.4),Je.projectiles.syncShots(t.p,Je.mechs,mi),Je.projectiles.syncBits(t.b,Je.mechs),Je.projectiles.syncBeams(t.l,Je.mechs),re.time=t.tm,re.cost.ally=t.c[1],re.cost.foe=t.c[0];for(const n of Je.mechs)n.hp<n.netPrevHp&&pb(n),n.st==="dead"&&n.netPrevSt!=="dead"&&Fi.explode(n.pos),n.netPrevHp=n.hp,n.netPrevSt=n.st}for(const n of Je.mechs){if(n.st==="dead"){n.root.visible=!1;continue}n.root.visible=!0,n.pos.addScaledVector(n.vel,s),n.root.position.copy(n.pos),n.root.rotation.y=n.yaw;const i=sh.floorAt(n.pos.x,n.pos.z),r=n.root.userData.shadow;r.position.y=i-n.pos.y+.03,n.animT+=s,n.stT+=s,n.pose(s),n.updateTrail()}Je.projectiles.extrapolate(s),Fi.update(s),jt.active||gn.update(s,re.self,re.foe),re.self&&mn.update(s,re),up()}function pb(s){const e=s.pos.clone();e.y+=1.6,Fi.hit(e,s.d.palette.beam)}function xc(s){oh(),re.mode=s;const e=s==="host"?cn:xp,t=s==="host"?Ml:cn;re.init(e,t,gi);const n=s==="host"?Je.mechs[0]:Je.mechs[1],i=s==="host"?Je.mechs[1]:Je.mechs[0];re.self=n,re.foe=i,n.isPlayer=!0,i.isPlayer=!1;for(const r of Je.mechs)r.netPrevHp=r.hp,r.netPrevSt=r.st;for(const r of as)la[r]=0,xa[r]=0,ha[r]=0;ua=null,vp=0,mn.setup(n,i),gn.snap(n,i),lh(),ve("gate").classList.add("hidden"),mn.show(),re.running=!0,re.paused=!1,re.over=!1,ve("pauseMenu").classList.add("hidden"),ve("pauseBtn").classList.remove("hidden"),ve("result").classList.add("hidden"),ve("touch").classList.remove("hidden"),os=performance.now(),mn.message("BATTLE START","#8fd6ff")}function yp(){re.mode!=="cpu"&&(mn.message("相手が退出しました","#ff6b74"),mt.close(),setTimeout(ch,1200))}function ah(s){const e=re.mode==="cpu";re.paused=s&&e,ve("pauseMenu").querySelector("h2").textContent=e?"PAUSE":"MENU",ve("resumeBtn").textContent=e?"続ける":"戻る",ve("pauseMenu").classList.toggle("hidden",!s),ve("touch").classList.toggle("hidden",s),os=performance.now()}function Sp(){oh(),re.mode="cpu",re.init(cn,_i,gi),re.running=!0,re.paused=!1,ve("pauseMenu").classList.add("hidden"),ve("pauseBtn").classList.remove("hidden"),ve("result").classList.add("hidden"),ve("touch").classList.remove("hidden"),os=performance.now(),mn.message("BATTLE START","#8fd6ff")}function ch(){oh(),mt.connected&&mt.send({t:"menu"}),mt.close(),lh(),re.mode="cpu",ve("netPing").classList.add("hidden"),re.running=!1,re.paused=!1,re.over=!1,ve("pauseMenu").classList.add("hidden"),ve("pauseBtn").classList.add("hidden"),ve("result").classList.add("hidden"),ve("touch").classList.add("hidden"),mn.hide(),ve("gate").classList.remove("hidden"),re.init(cn,_i,gi),os=performance.now()}function Mp(s){for(const e of document.querySelectorAll("#modePick .md"))e.classList.toggle("on",e.dataset.mode===s);ve("lvPick").classList.toggle("hidden",s!=="cpu"),ve("startBtn").classList.toggle("hidden",s!=="cpu"),ve("netPick").classList.toggle("hidden",s!=="net"),ve("foePick").parentElement.classList.toggle("hidden",s!=="cpu"),ve("stageNote").textContent=s==="cpu"?"":"部屋を作った側のものが使われます"}function bp(s){ve("netPanel").classList.remove("hidden"),ve("netTitle").textContent=s==="host"?"部屋を作る":"部屋に入る",ve("netHostBox").classList.toggle("hidden",s!=="host"),ve("netJoinBox").classList.toggle("hidden",s!=="join"),ve("netStatus").className="netStatus",ve("netJoinStatus").className="netStatus",ve("netJoinStatus").textContent=""}function lh(){ve("netPanel").classList.add("hidden")}function ui(s,e,t){const n=ve(s);n.textContent=e,n.className="netStatus"+(t?" err":"")}mt.onMessage=ub;mt.onState=(s,e)=>{s==="waiting"&&ui("netStatus","相手の接続を待っています…"),s==="connected"&&mt.role==="host"&&ui("netStatus","接続しました。開始します…"),s==="connected"&&mt.role==="guest"&&ui("netJoinStatus","接続しました。開始を待っています…"),s==="error"&&ui(mt.role==="guest"?"netJoinStatus":"netStatus",e||"接続エラー",!0),s==="closed"&&re.running&&yp()};ve("hostBtn").addEventListener("click",async()=>{bp("host"),ve("roomCode").textContent="----",ui("netStatus","部屋を準備中…");try{const s=await mt.host();ve("roomCode").textContent=s}catch{}});ve("joinBtn").addEventListener("click",()=>{bp("join"),ve("codeInput").value="",setTimeout(()=>ve("codeInput").focus(),50)});ve("codeInput").addEventListener("input",s=>{s.target.value=nh(s.target.value)});ve("codeInput").addEventListener("keydown",s=>{s.key==="Enter"&&ve("connectBtn").click()});ve("connectBtn").addEventListener("click",async()=>{const s=nh(ve("codeInput").value);if(s.length<4){ui("netJoinStatus","4文字のコードを入れてください",!0);return}ui("netJoinStatus","接続中…");try{await mt.join(s),mt.send({t:"hello",mech:cn})}catch{}});ve("netCancelBtn").addEventListener("click",()=>{mt.close(),lh()});for(const s of document.querySelectorAll("#modePick .md"))s.addEventListener("click",()=>Mp(s.dataset.mode));Mp("cpu");ve("pauseBtn").addEventListener("click",()=>{re.running&&!re.over&&ah(!0)});ve("resumeBtn").addEventListener("click",()=>ah(!1));ve("toMenuBtn").addEventListener("click",ch);ve("resultMenuBtn").addEventListener("click",ch);addEventListener("keydown",s=>{s.code==="Escape"&&re.running&&!re.over&&ah(!re.paused)});ve("startBtn").addEventListener("click",()=>{ve("gate").classList.add("hidden"),mn.show(),Sp()});ve("againBtn").addEventListener("click",Sp);
