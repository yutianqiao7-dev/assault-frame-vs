...
export const MECHS = {
  ...
  garm: {
    ...
    weapons: {
      shot:     { label:'AM', name:'アサルトマシンガン', kind:'bullet',
                  ammo:13, reload:4.0, dmg:16, down:0.35, speed:135, life:1.2,
                  cooldown:0.33, fireDelay:0.08, homing:0.6, radius:0.3, burst:3, burstGap:0.09 },
  ...
  vulca: {
    ...
    weapons: {
      ...
      sub:      { label:'FN', name:'ファンネル', kind:'funnel',
                  ammo:6, reload:9.0, dmg:30, down:0.9, speed:150, life:1.0,
                  cooldown:1.5, fireDelay:0.2, homing:0.8, radius:0.4,
                  count:3, bitTime:3.0, bitOrbit:16, bitFireGap:0.95 },
  ...
  lava: {
    ...
    weapons: {
      shot:     { label:'VC', name:'バルカン', kind:'bullet',
                  ammo:12, reload:4.0, dmg:13, down:0.3, speed:140, life:1.1,
                  cooldown:0.36, fireDelay:0.06, homing:0.55, radius:0.28, burst:4, burstGap:0.07 },
  ...
  titan: {
    ...
    weapons: {
      shot:     { label:'GT', name:'ガトリング', kind:'bullet',
                  ammo:9, reload:4.6, dmg:14, down:0.28, speed:145, life:1.3,
                  cooldown:0.47, fireDelay:0.08, homing:0.55, radius:0.3, burst:5, burstGap:0.06 },
  ...
  seraph: {
    ...
    weapons: {
      ...
      sub:      { label:'FN', name:'ファンネル', kind:'funnel',
                  ammo:6, reload:9.0, dmg:26, down:0.8, speed:155, life:1.0,
                  cooldown:1.4, fireDelay:0.2, homing:0.85, radius:0.38,
                  count:6, bitTime:3.2, bitOrbit:18, bitFireGap:0.95 },
  ...
  bulwark: {
    ...
    weapons: {
      shot:     { label:'GG', name:'ガトリング', kind:'bullet',
                  ammo:10, reload:4.5, dmg:11, down:0.22, speed:150, life:1.2,
                  cooldown:0.44, fireDelay:0.05, homing:0.5, radius:0.26, burst:6, burstGap:0.06 },
  ...
  hazel: {
    ...
    weapons: {
      shot:     { label:'AR', name:'アサルトライフル', kind:'bullet',
                  ammo:12, reload:3.6, dmg:16, down:0.35, speed:145, life:1.2,
                  cooldown:0.33, fireDelay:0.07, homing:0.6, radius:0.28, burst:3, burstGap:0.08 },
  ...
  lance: {
    ...
    weapons: {
      ...
      // 照射は追尾するのでステップで振り切れない。1 回の威力と回転の両方を
      // 他の照射持ち（ヴァルカ/ソヴリン）より強くすると突出する
      sub:      { label:'PC', name:'パルスキャノン', kind:'laser',
                  ammo:1, reload:10.0, dmg:27, down:0.5, duration:1.1, tickGap:0.1,
                  cooldown:1.6, fireDelay:0.3, range:120, radius:1.4, turn:1.3 },
